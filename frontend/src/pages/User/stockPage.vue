    ...
    <div class="q-pa-md" style="width: 100%;">
        <div class="row">
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 q-pa-sm">
                ...
                >
                    <q-card-section>
                        <span class="text-h6 text-bold">Stock Management</span><br/>
                        <span class="text-caption text-grey">Products List and Manage product stocks</span><br/>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 q-pa-sm">
                <q-tabs
                    ...
                    class="text-primary"
                >
                    <q-tab :ripple="false" name="In-stock" icon="ti-package" label="Available Units" />
                    <q-tab :ripple="false" name="Out for Delivery" icon="ti-truck" label="For Delivery" />
                    <q-tab :ripple="false" name="Installed" icon="ti-check-box" label="Installed Units" />
                </q-tabs>
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 q-pa-sm">
                <q-input 
...
export default {
    ...
    methods: {
        ...
        async fetchProductList(){
            ...
            try {
                const res = await getQueryStock(`productStock`, 'status', this.tab)
                this.itemsList = res;
