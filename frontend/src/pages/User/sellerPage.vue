                ...
                >
                    <q-card-section>
                        ...
                        <div class="text-right">
                            <q-btn-group rounded>
                                <q-btn color="primary" rounded glossy icon="ti-plus" label="Add Seller" no-caps @click="addItemModal = !addItemModal" />
                            </q-btn-group>
                        </div>
                    </q-card-section>
                </q-card>
...
import AddSellerModal from "../../components/Modals/AddSellerModal.vue"
...
export default {
    ...
    methods: {
        ...
        async fetchProductList(){
            ...
            try {
                const res = await getQueryStock(`sellerList`)
                this.itemsList = res;
